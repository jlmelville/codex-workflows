...
decisive_evidence:
  ...
  - "Manual validation run 29385262003 passed every validation and workflow-audit step on Ubuntu and macOS after commits 25f08ec and ee2e748."
...
setup failure after actionlint installed successfully. Commit `ee2e748`
isolated those tools in a temporary virtual environment; the follow-up manual
run passed the complete Ubuntu and macOS validation lanes.
